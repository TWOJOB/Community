...
$name_company = '세상바꿈'; // 회사명 입력
$name_site = '025 (쇼핑몰)'; // 사이트 또는 쇼핑몰명 입력
$enforcement_date = '2021년 02월 O6일'; // 시행일
...
<div class="pb-4 px-3 px-sm-0 font-weight-normal">
	...
	<p class="pb-2">이 약관은 <?php echo $name_company ?>(전자상거래 사업자로 이하 "회사"라 한다)이 운영하는 <?php echo $name_site ?>(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p> 
